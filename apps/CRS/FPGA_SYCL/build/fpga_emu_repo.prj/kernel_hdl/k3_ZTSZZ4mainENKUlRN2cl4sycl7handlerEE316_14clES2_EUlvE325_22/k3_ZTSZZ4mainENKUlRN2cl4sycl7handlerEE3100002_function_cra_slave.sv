...
// SystemVerilog created from k3_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE3100002_function_cra_slave
...
module k3_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE3100002_function_cra_slave (
    ...
    output wire [2143:0] kernel_arguments,
    ...
    reg [31:0] arguments_58_q;
    reg [31:0] arguments_58_buffered_q;
    reg [31:0] arguments_59_q;
    reg [31:0] arguments_59_buffered_q;
    reg [31:0] arguments_5_buffered_q;
    reg [31:0] arguments_6_q;
    reg [31:0] arguments_60_q;
    reg [31:0] arguments_60_buffered_q;
    reg [31:0] arguments_61_q;
    reg [31:0] arguments_61_buffered_q;
    reg [31:0] arguments_62_q;
    reg [31:0] arguments_62_buffered_q;
    reg [31:0] arguments_63_q;
    reg [31:0] arguments_63_buffered_q;
    reg [31:0] arguments_64_q;
    reg [31:0] arguments_64_buffered_q;
    reg [31:0] arguments_65_q;
    reg [31:0] arguments_65_buffered_q;
    reg [31:0] arguments_66_q;
    reg [31:0] arguments_66_buffered_q;
    ...
    wire [2143:0] kernel_arg_bit_join_q;
    ...
    wire [63:0] dupName_19_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_20_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_21_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_22_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_23_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_24_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_25_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_26_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_27_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_28_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_29_arg_bit_join_x_q;
    ...
    wire [63:0] dupName_30_arg_bit_join_x_q;
    ...
    wire [0:0] dupName_43_NO_NAME_x_q;
    wire [5:0] dupName_43_address_ref_x_q;
    wire [0:0] dupName_43_can_write_x_q;
    wire [31:0] dupName_43_mask0_x_q;
    wire [31:0] dupName_43_new_data_x_q;
    wire [0:0] dupName_44_NO_NAME_x_q;
    wire [5:0] dupName_44_address_ref_x_q;
    wire [0:0] dupName_44_can_write_x_q;
    wire [31:0] dupName_44_mask0_x_q;
    wire [31:0] dupName_44_new_data_x_q;
    wire [0:0] dupName_45_NO_NAME_x_q;
    wire [5:0] dupName_45_address_ref_x_q;
    wire [0:0] dupName_45_can_write_x_q;
    wire [31:0] dupName_45_mask0_x_q;
    wire [31:0] dupName_45_new_data_x_q;
    wire [0:0] dupName_46_NO_NAME_x_q;
    wire [5:0] dupName_46_address_ref_x_q;
    wire [0:0] dupName_46_can_write_x_q;
    wire [31:0] dupName_46_mask0_x_q;
    wire [31:0] dupName_46_new_data_x_q;
    wire [0:0] dupName_47_NO_NAME_x_q;
    wire [5:0] dupName_47_address_ref_x_q;
    wire [0:0] dupName_47_can_write_x_q;
    ...
    wire [31:0] dupName_75_mask0_x_q;
    wire [31:0] dupName_75_new_data_x_q;
    wire [31:0] dupName_76_mask0_x_q;
    wire [31:0] dupName_76_new_data_x_q;
    wire [31:0] dupName_77_mask0_x_q;
    wire [31:0] dupName_77_new_data_x_q;
    wire [31:0] dupName_78_mask0_x_q;
    wire [31:0] dupName_78_new_data_x_q;
    wire [31:0] dupName_79_mask0_x_q;
    wire [31:0] dupName_79_new_data_x_q;
    wire [31:0] dupName_80_mask0_x_q;
    wire [31:0] dupName_80_new_data_x_q;
    wire [31:0] dupName_81_mask0_x_q;
    wire [31:0] dupName_81_new_data_x_q;
    wire [31:0] dupName_82_mask0_x_q;
    wire [31:0] dupName_82_new_data_x_q;
    wire [31:0] dupName_83_mask0_x_q;
    wire [31:0] dupName_83_new_data_x_q;


    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // version_number(CONSTANT,306)
    ...
    // not_finished(LOGICAL,236)
    assign not_finished_q = ~ (finish);

    // compute_running_not_done(LOGICAL,159)
    ...
    // printf_bit(BITSELECT,269)
    assign printf_bit_b = status_NO_SHIFT_REG_q[3:3];

    // printf_bit_mux(MUX,270)
    ...
    // readdata_valid_stage1_reg(REG,277)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // finish_counter_NO_SHIFT_REG(REG,173)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // can_write(LOGICAL,150)
    assign can_write_q = NO_NAME_q & avs_cra_write;

    // status_select(MUX,303)
    ...
    // printf_reset_bit(BITSELECT,272)
    assign printf_reset_bit_b = status_NO_SHIFT_REG_q[4:4];

    // acl_counter_reset(GPOUT,247)
    assign acl_counter_reset = printf_reset_bit_b;

    // const_finish_counter_padding(CONSTANT,163)
    ...
    // cra_output_was_finish_counter_address_stage2_reg(REG,168)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // cra_output_readdata_reg(REG,165)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // avs_cra_readdata(GPOUT,248)
    assign avs_cra_readdata = cra_output_readdata_reg_q;

    // readdata_valid_stage2_reg(REG,278)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // cra_output_readdatavalid_reg(REG,166)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_0(REG,189)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_0(REG,183)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_1_buffered(REG,192)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_1(REG,191)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_1(REG,185)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_upper_2(REG,193)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_2_buffered(REG,188)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_offset_reg_lower_2(REG,187)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_0(REG,198)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_1(REG,200)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_size_reg_lower_2(REG,202)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // global_size_2_bit_join(BITJOIN,197)
    assign global_size_2_bit_join_q = {global_size_reg_upper_0_q, global_size_reg_lower_2_q};

    // global_size_2(GPOUT,256)
    assign global_size_2 = global_size_2_bit_join_q;

    // dupName_47_address_ref_x(CONSTANT,644)
    assign dupName_47_address_ref_x_q = $unsigned(6'b110000);

    // dupName_47_NO_NAME_x(LOGICAL,643)
    assign dupName_47_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_47_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_47_can_write_x(LOGICAL,645)
    assign dupName_47_can_write_x_q = dupName_47_NO_NAME_x_q & avs_cra_write;

    // dupName_83_mask0_x(LOGICAL,754)
    assign dupName_83_mask0_x_q = bit_enable_bottom_bar_b & arguments_66_buffered_q;

    // dupName_83_new_data_x(LOGICAL,756)
    assign dupName_83_new_data_x_q = dupName_83_mask0_x_q | mask1_q;

    // arguments_66_buffered(REG,133)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_66_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_47_can_write_x_q == 1'b1)
        begin
            arguments_66_buffered_q <= dupName_83_new_data_x_q;
        end
    end

    // arguments_66(REG,132)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_66_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_66_q <= arguments_66_buffered_q;
        end
    end

    // dupName_46_address_ref_x(CONSTANT,638)
    assign dupName_46_address_ref_x_q = $unsigned(6'b101111);

    // dupName_46_NO_NAME_x(LOGICAL,637)
    assign dupName_46_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_46_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_46_can_write_x(LOGICAL,639)
    assign dupName_46_can_write_x_q = dupName_46_NO_NAME_x_q & avs_cra_write;

    // dupName_82_mask0_x(LOGICAL,751)
    assign dupName_82_mask0_x_q = bit_enable_top_bar_b & arguments_65_buffered_q;

    // dupName_82_new_data_x(LOGICAL,753)
    assign dupName_82_new_data_x_q = dupName_82_mask0_x_q | dupName_1_mask1_x_q;

    // arguments_65_buffered(REG,131)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_65_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_46_can_write_x_q == 1'b1)
        begin
            arguments_65_buffered_q <= dupName_82_new_data_x_q;
        end
    end

    // arguments_65(REG,130)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_65_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_65_q <= arguments_65_buffered_q;
        end
    end

    // dupName_30_arg_bit_join_x(BITJOIN,541)
    assign dupName_30_arg_bit_join_x_q = {arguments_66_q, arguments_65_q};

    // dupName_81_mask0_x(LOGICAL,748)
    assign dupName_81_mask0_x_q = bit_enable_bottom_bar_b & arguments_64_buffered_q;

    // dupName_81_new_data_x(LOGICAL,750)
    assign dupName_81_new_data_x_q = dupName_81_mask0_x_q | mask1_q;

    // arguments_64_buffered(REG,129)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_64_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_46_can_write_x_q == 1'b1)
        begin
            arguments_64_buffered_q <= dupName_81_new_data_x_q;
        end
    end

    // arguments_64(REG,128)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_64_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_64_q <= arguments_64_buffered_q;
        end
    end

    // dupName_45_address_ref_x(CONSTANT,632)
    assign dupName_45_address_ref_x_q = $unsigned(6'b101110);

    // dupName_45_NO_NAME_x(LOGICAL,631)
    assign dupName_45_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_45_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_45_can_write_x(LOGICAL,633)
    assign dupName_45_can_write_x_q = dupName_45_NO_NAME_x_q & avs_cra_write;

    // dupName_80_mask0_x(LOGICAL,745)
    assign dupName_80_mask0_x_q = bit_enable_top_bar_b & arguments_63_buffered_q;

    // dupName_80_new_data_x(LOGICAL,747)
    assign dupName_80_new_data_x_q = dupName_80_mask0_x_q | dupName_1_mask1_x_q;

    // arguments_63_buffered(REG,127)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_63_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_45_can_write_x_q == 1'b1)
        begin
            arguments_63_buffered_q <= dupName_80_new_data_x_q;
        end
    end

    // arguments_63(REG,126)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_63_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_63_q <= arguments_63_buffered_q;
        end
    end

    // dupName_29_arg_bit_join_x(BITJOIN,533)
    assign dupName_29_arg_bit_join_x_q = {arguments_64_q, arguments_63_q};

    // dupName_79_mask0_x(LOGICAL,742)
    assign dupName_79_mask0_x_q = bit_enable_bottom_bar_b & arguments_62_buffered_q;

    // dupName_79_new_data_x(LOGICAL,744)
    assign dupName_79_new_data_x_q = dupName_79_mask0_x_q | mask1_q;

    // arguments_62_buffered(REG,125)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_62_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_45_can_write_x_q == 1'b1)
        begin
            arguments_62_buffered_q <= dupName_79_new_data_x_q;
        end
    end

    // arguments_62(REG,124)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_62_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_62_q <= arguments_62_buffered_q;
        end
    end

    // dupName_44_address_ref_x(CONSTANT,626)
    assign dupName_44_address_ref_x_q = $unsigned(6'b101101);

    // dupName_44_NO_NAME_x(LOGICAL,625)
    assign dupName_44_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_44_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_44_can_write_x(LOGICAL,627)
    assign dupName_44_can_write_x_q = dupName_44_NO_NAME_x_q & avs_cra_write;

    // dupName_78_mask0_x(LOGICAL,739)
    assign dupName_78_mask0_x_q = bit_enable_top_bar_b & arguments_61_buffered_q;

    // dupName_78_new_data_x(LOGICAL,741)
    assign dupName_78_new_data_x_q = dupName_78_mask0_x_q | dupName_1_mask1_x_q;

    // arguments_61_buffered(REG,123)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_61_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_44_can_write_x_q == 1'b1)
        begin
            arguments_61_buffered_q <= dupName_78_new_data_x_q;
        end
    end

    // arguments_61(REG,122)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_61_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_61_q <= arguments_61_buffered_q;
        end
    end

    // dupName_28_arg_bit_join_x(BITJOIN,525)
    assign dupName_28_arg_bit_join_x_q = {arguments_62_q, arguments_61_q};

    // dupName_77_mask0_x(LOGICAL,736)
    assign dupName_77_mask0_x_q = bit_enable_bottom_bar_b & arguments_60_buffered_q;

    // dupName_77_new_data_x(LOGICAL,738)
    assign dupName_77_new_data_x_q = dupName_77_mask0_x_q | mask1_q;

    // arguments_60_buffered(REG,121)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_60_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_44_can_write_x_q == 1'b1)
        begin
            arguments_60_buffered_q <= dupName_77_new_data_x_q;
        end
    end

    // arguments_60(REG,120)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_60_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_60_q <= arguments_60_buffered_q;
        end
    end

    // dupName_43_address_ref_x(CONSTANT,620)
    assign dupName_43_address_ref_x_q = $unsigned(6'b101100);

    // dupName_43_NO_NAME_x(LOGICAL,619)
    assign dupName_43_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_43_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_43_can_write_x(LOGICAL,621)
    assign dupName_43_can_write_x_q = dupName_43_NO_NAME_x_q & avs_cra_write;

    // dupName_76_mask0_x(LOGICAL,733)
    assign dupName_76_mask0_x_q = bit_enable_top_bar_b & arguments_59_buffered_q;

    // dupName_76_new_data_x(LOGICAL,735)
    assign dupName_76_new_data_x_q = dupName_76_mask0_x_q | dupName_1_mask1_x_q;

    // arguments_59_buffered(REG,117)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_59_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_43_can_write_x_q == 1'b1)
        begin
            arguments_59_buffered_q <= dupName_76_new_data_x_q;
        end
    end

    // arguments_59(REG,116)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_59_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_59_q <= arguments_59_buffered_q;
        end
    end

    // dupName_27_arg_bit_join_x(BITJOIN,517)
    assign dupName_27_arg_bit_join_x_q = {arguments_60_q, arguments_59_q};

    // dupName_75_mask0_x(LOGICAL,730)
    assign dupName_75_mask0_x_q = bit_enable_bottom_bar_b & arguments_58_buffered_q;

    // dupName_75_new_data_x(LOGICAL,732)
    assign dupName_75_new_data_x_q = dupName_75_mask0_x_q | mask1_q;

    // arguments_58_buffered(REG,115)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_58_buffered_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (dupName_43_can_write_x_q == 1'b1)
        begin
            arguments_58_buffered_q <= dupName_75_new_data_x_q;
        end
    end

    // arguments_58(REG,114)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            arguments_58_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (start_from_buffered_start_NO_SHIFT_REG_q == 1'b1)
        begin
            arguments_58_q <= arguments_58_buffered_q;
        end
    end

    // dupName_42_address_ref_x(CONSTANT,614)
    assign dupName_42_address_ref_x_q = $unsigned(6'b101011);

    // dupName_42_NO_NAME_x(LOGICAL,613)
    assign dupName_42_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_42_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_42_can_write_x(LOGICAL,615)
    assign dupName_42_can_write_x_q = dupName_42_NO_NAME_x_q & avs_cra_write;

    // dupName_74_mask0_x(LOGICAL,727)
    assign dupName_74_mask0_x_q = bit_enable_top_bar_b & arguments_57_buffered_q;

    // dupName_74_new_data_x(LOGICAL,729)
    ...
    // dupName_26_arg_bit_join_x(BITJOIN,509)
    assign dupName_26_arg_bit_join_x_q = {arguments_58_q, arguments_57_q};

    // dupName_73_mask0_x(LOGICAL,724)
    assign dupName_73_mask0_x_q = bit_enable_bottom_bar_b & arguments_56_buffered_q;

    // dupName_73_new_data_x(LOGICAL,726)
    ...
    // dupName_25_arg_bit_join_x(BITJOIN,501)
    assign dupName_25_arg_bit_join_x_q = {arguments_56_q, arguments_55_q};

    // dupName_71_mask0_x(LOGICAL,718)
    assign dupName_71_mask0_x_q = bit_enable_bottom_bar_b & arguments_54_buffered_q;

    // dupName_71_new_data_x(LOGICAL,720)
    ...
    // dupName_24_arg_bit_join_x(BITJOIN,493)
    assign dupName_24_arg_bit_join_x_q = {arguments_54_q, arguments_53_q};

    // dupName_69_mask0_x(LOGICAL,712)
    assign dupName_69_mask0_x_q = bit_enable_bottom_bar_b & arguments_52_buffered_q;

    // dupName_69_new_data_x(LOGICAL,714)
    ...
    // dupName_23_arg_bit_join_x(BITJOIN,485)
    assign dupName_23_arg_bit_join_x_q = {arguments_52_q, arguments_51_q};

    // dupName_67_mask0_x(LOGICAL,706)
    assign dupName_67_mask0_x_q = bit_enable_bottom_bar_b & arguments_50_buffered_q;

    // dupName_67_new_data_x(LOGICAL,708)
    ...
    // dupName_22_arg_bit_join_x(BITJOIN,477)
    assign dupName_22_arg_bit_join_x_q = {arguments_50_q, arguments_49_q};

    // dupName_65_mask0_x(LOGICAL,700)
    assign dupName_65_mask0_x_q = bit_enable_bottom_bar_b & arguments_48_buffered_q;

    // dupName_65_new_data_x(LOGICAL,702)
    ...
    // dupName_21_arg_bit_join_x(BITJOIN,469)
    assign dupName_21_arg_bit_join_x_q = {arguments_48_q, arguments_47_q};

    // dupName_63_mask0_x(LOGICAL,694)
    assign dupName_63_mask0_x_q = bit_enable_bottom_bar_b & arguments_46_buffered_q;

    // dupName_63_new_data_x(LOGICAL,696)
    ...
    // dupName_20_arg_bit_join_x(BITJOIN,461)
    assign dupName_20_arg_bit_join_x_q = {arguments_46_q, arguments_45_q};

    // dupName_61_mask0_x(LOGICAL,688)
    assign dupName_61_mask0_x_q = bit_enable_bottom_bar_b & arguments_44_buffered_q;

    // dupName_61_new_data_x(LOGICAL,690)
    ...
    // dupName_19_arg_bit_join_x(BITJOIN,453)
    assign dupName_19_arg_bit_join_x_q = {arguments_44_q, arguments_43_q};

    // dupName_59_mask0_x(LOGICAL,682)
    assign dupName_59_mask0_x_q = bit_enable_bottom_bar_b & arguments_42_buffered_q;

    // dupName_59_new_data_x(LOGICAL,684)
    ...
    // dupName_29_address_ref_x(CONSTANT,532)
    assign dupName_29_address_ref_x_q = $unsigned(6'b011110);

    // dupName_29_NO_NAME_x(LOGICAL,531)
    ...
    // dupName_1_arg_bit_join_x(BITJOIN,319)
    ...
    // dupName_0_arg_bit_join_x(BITJOIN,312)
    ...
    // kernel_arg_bit_join(BITJOIN,223)
    assign kernel_arg_bit_join_q = {dupName_30_arg_bit_join_x_q, dupName_29_arg_bit_join_x_q, dupName_28_arg_bit_join_x_q, dupName_27_arg_bit_join_x_q, dupName_26_arg_bit_join_x_q, dupName_25_arg_bit_join_x_q, dupName_24_arg_bit_join_x_q, dupName_23_arg_bit_join_x_q, dupName_22_arg_bit_join_x_q, dupName_21_arg_bit_join_x_q, dupName_20_arg_bit_join_x_q, dupName_19_arg_bit_join_x_q, dupName_18_arg_bit_join_x_q, dupName_17_arg_bit_join_x_q, dupName_16_arg_bit_join_x_q, dupName_15_arg_bit_join_x_q, dupName_14_arg_bit_join_x_q, dupName_13_arg_bit_join_x_q, dupName_12_arg_bit_join_x_q, dupName_11_arg_bit_join_x_q, dupName_10_arg_bit_join_x_q, dupName_9_arg_bit_join_x_q, dupName_8_arg_bit_join_x_q, dupName_7_arg_bit_join_x_q, dupName_6_arg_bit_join_x_q, dupName_5_arg_bit_join_x_q, arguments_14_q, dupName_4_arg_bit_join_x_q, dupName_3_arg_bit_join_x_q, dupName_2_arg_bit_join_x_q, dupName_1_arg_bit_join_x_q, dupName_0_arg_bit_join_x_q, arg_bit_join_q, arguments_1_q, arguments_0_q};

    // kernel_arguments(GPOUT,257)
    assign kernel_arguments = kernel_arg_bit_join_q;

    // dupName_9_address_ref_x(CONSTANT,372)
    assign dupName_9_address_ref_x_q = $unsigned(6'b001010);

    // dupName_9_NO_NAME_x(LOGICAL,371)
    assign dupName_9_NO_NAME_x_q = $unsigned(avs_cra_address == dupName_9_address_ref_x_q ? 1'b1 : 1'b0);

    // dupName_9_can_write_x(LOGICAL,374)
    assign dupName_9_can_write_x_q = dupName_9_NO_NAME_x_q & avs_cra_write;

    // dupName_8_mask0_x(LOGICAL,368)
    assign dupName_8_mask0_x_q = bit_enable_bottom_bar_b & local_size_reg_0_buffered_q;

    // dupName_8_new_data_x(LOGICAL,370)
    assign dupName_8_new_data_x_q = dupName_8_mask0_x_q | mask1_q;

    // local_size_reg_0_buffered(REG,226)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
    ...
    // next_start_reg_value(LOGICAL,234)
    ...
    // workgroup_size_NO_SHIFT_REG(REG,310)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
