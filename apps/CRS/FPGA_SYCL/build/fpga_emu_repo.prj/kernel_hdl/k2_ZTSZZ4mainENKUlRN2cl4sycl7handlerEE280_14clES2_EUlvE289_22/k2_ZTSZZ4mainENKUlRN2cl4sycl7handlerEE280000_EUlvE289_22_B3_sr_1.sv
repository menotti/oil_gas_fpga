...
// SystemVerilog created from k2_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE280000_EUlvE289_22_B3_sr_1
...
module k2_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE280000_EUlvE289_22_B3_sr_1 (
    ...
    input wire [32:0] in_i_data_9_tpl,
    ...
    output wire [32:0] out_o_data_9_tpl,
    ...
    begin
        if (!resetn)
        begin
            sr_9_x_q <= $unsigned(33'b000000000000000000000000000000000);
        end
        else if (not_sr_valid_q == 1'b1)
        begin
