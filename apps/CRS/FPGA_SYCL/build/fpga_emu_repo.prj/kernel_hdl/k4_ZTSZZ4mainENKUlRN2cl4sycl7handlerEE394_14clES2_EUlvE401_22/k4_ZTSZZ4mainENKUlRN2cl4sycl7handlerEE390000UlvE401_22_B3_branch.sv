...
// SystemVerilog created from k4_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE390000UlvE401_22_B3_branch
// SystemVerilog created on Thu Oct 22 21:57:47 2020


(* altera_attribute = "-name AUTO_SHIFT_REGISTER_RECOGNITION OFF; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 10037; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 15400; -name MESSAGE_DISABLE 14130; -name MESSAGE_DISABLE 10036; -name MESSAGE_DISABLE 12020; -name MESSAGE_DISABLE 12030; -name MESSAGE_DISABLE 12010; -name MESSAGE_DISABLE 12110; -name MESSAGE_DISABLE 14320; -name MESSAGE_DISABLE 13410; -name MESSAGE_DISABLE 113007; -name MESSAGE_DISABLE 10958" *)
module k4_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE390000UlvE401_22_B3_branch (
    ...
    input wire [0:0] in_c0_exe572,
    input wire [0:0] in_c0_exe673,
    input wire [0:0] in_c0_exe774,
    ...
    wire [0:0] VCC_q;
    wire [0:0] ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q;
    wire [0:0] ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_not_q;
    wire [0:0] c0_exe11_cmp_q;
    reg [0:0] c0_exe12_reg_q;
    reg [31:0] c0_exe13_reg_q;
    reg [0:0] c0_exe14_reg_q;
    reg [0:0] c0_exe15_reg_q;
    reg [0:0] c0_exe269_reg_q;
    reg [0:0] c0_exe572_reg_q;
    reg [0:0] c0_exe673_reg_q;
    reg [0:0] c0_exe774_reg_q;
    ...
    begin
        ...
        else if (ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q == 1'b1)
        begin
    ...
    // ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable(LOGICAL,2)
    assign ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // out_c0_exe269(GPOUT,41)
    assign out_c0_exe269 = c0_exe269_reg_q;

    // c0_exe572_reg(REG,10)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            c0_exe572_reg_q <= $unsigned(1'b0);
        end
        else if (ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q == 1'b1)
        begin
    ...
    // out_c0_exe572(GPOUT,42)
    assign out_c0_exe572 = c0_exe572_reg_q;

    // c0_exe673_reg(REG,11)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            c0_exe673_reg_q <= $unsigned(1'b0);
        end
        else if (ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q == 1'b1)
        begin
            c0_exe673_reg_q <= in_c0_exe673;
        end
    end

    // out_c0_exe673(GPOUT,43)
    assign out_c0_exe673 = c0_exe673_reg_q;

    // c0_exe774_reg(REG,12)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            c0_exe774_reg_q <= $unsigned(1'b0);
        end
        else if (ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q == 1'b1)
        begin
            c0_exe774_reg_q <= in_c0_exe774;
        end
    end

    // out_c0_exe774(GPOUT,44)
    assign out_c0_exe774 = c0_exe774_reg_q;
    ...
    // ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_not(LOGICAL,3)
    assign ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_not_q = ~ (ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_q);

    // out_stall_out(GPOUT,48)
    assign out_stall_out = ZTSZZ4mainENKUlRN2cl4sycl7handlerEE394_14clES2_EUlvE401_22_B3_branch_enable_not_q;
