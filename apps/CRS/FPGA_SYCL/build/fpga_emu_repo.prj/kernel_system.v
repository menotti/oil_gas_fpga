...
(
   ...
   logic [9:0] sys_cra_ring_address;
   ...
   // INST log_b6fd8f_sys of log_b6fd8f_sys
   log_b6fd8f_sys log_b6fd8f_sys
   (
      ...
      .avm_memgmem0_DDR_port_0_0_rw_enable(kernel_ddr4a_enable),
      .avm_memgmem0_DDR_port_0_0_rw_read(kernel_ddr4a_read),
      .avm_memgmem0_DDR_port_0_0_rw_write(kernel_ddr4a_write),
      .avm_memgmem0_DDR_port_0_0_rw_address(kernel_ddr4a_address),
      .avm_memgmem0_DDR_port_0_0_rw_writedata(kernel_ddr4a_writedata),
      .avm_memgmem0_DDR_port_0_0_rw_byteenable(kernel_ddr4a_byteenable),
      .avm_memgmem0_DDR_port_0_0_rw_waitrequest(kernel_ddr4a_waitrequest),
      .avm_memgmem0_DDR_port_0_0_rw_readdata(kernel_ddr4a_readdata),
      .avm_memgmem0_DDR_port_0_0_rw_readdatavalid(kernel_ddr4a_readdatavalid),
      .avm_memgmem0_DDR_port_0_0_rw_burstcount(kernel_ddr4a_burstcount),
      .avm_memgmem0_DDR_port_0_0_rw_writeack(kernel_ddr4a_writeack),
      // AVM avm_memgmem0_DDR_port_1_0_rw
      .avm_memgmem0_DDR_port_1_0_rw_enable(kernel_ddr4b_enable),
      .avm_memgmem0_DDR_port_1_0_rw_read(kernel_ddr4b_read),
      .avm_memgmem0_DDR_port_1_0_rw_write(kernel_ddr4b_write),
      .avm_memgmem0_DDR_port_1_0_rw_address(kernel_ddr4b_address),
      .avm_memgmem0_DDR_port_1_0_rw_writedata(kernel_ddr4b_writedata),
      .avm_memgmem0_DDR_port_1_0_rw_byteenable(kernel_ddr4b_byteenable),
      .avm_memgmem0_DDR_port_1_0_rw_waitrequest(kernel_ddr4b_waitrequest),
      .avm_memgmem0_DDR_port_1_0_rw_readdata(kernel_ddr4b_readdata),
      .avm_memgmem0_DDR_port_1_0_rw_readdatavalid(kernel_ddr4b_readdatavalid),
      .avm_memgmem0_DDR_port_1_0_rw_burstcount(kernel_ddr4b_burstcount),
      .avm_memgmem0_DDR_port_1_0_rw_writeack(kernel_ddr4b_writeack),
