...
// SystemVerilog created from k1_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE160001cqdq06oucqdq06oucqz3
...
module k1_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE160001cqdq06oucqdq06oucqz3 (
    ...
    reg [22:0] redist2_frac_x_uid11_block_rsrvd_fix_b_1_q;
    ...
    // redist2_frac_x_uid11_block_rsrvd_fix_b_1(DELAY,48)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_frac_x_uid11_block_rsrvd_fix_b_1_q <= '0;
        end
        else
        begin
            redist2_frac_x_uid11_block_rsrvd_fix_b_1_q <= $unsigned(frac_x_uid11_block_rsrvd_fix_b);
        end
    end
    ...
    // fracXIsZero_uid14_block_rsrvd_fix(LOGICAL,13)@1
    assign fracXIsZero_uid14_block_rsrvd_fix_q = $unsigned(cstZeroWF_uid8_block_rsrvd_fix_q == redist2_frac_x_uid11_block_rsrvd_fix_b_1_q ? 1'b1 : 1'b0);
    ...
    // expOvf_uid29_block_rsrvd_fix(COMPARE,28)@0 + 1
    ...
    // inRegAndOvf_uid32_block_rsrvd_fix(LOGICAL,31)@1
    ...
    // expUdf_uid27_block_rsrvd_fix(COMPARE,26)@0 + 1
    ...
    // inRegAndUdf_uid30_block_rsrvd_fix(LOGICAL,29)@1
    ...
    assign excRZero_uid31_block_rsrvd_fix_q = excZ_x_uid12_block_rsrvd_fix_q | inRegAndUdf_uid30_block_rsrvd_fix_q;
    ...
    assign fracR_uid24_block_rsrvd_fix_q = {redist2_frac_x_uid11_block_rsrvd_fix_b_1_q, zP_uid23_block_rsrvd_fix_q};
