...
// SystemVerilog created from k3_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE290000UlvE298_21_B1_branch
...
module k3_ZTSZZ4mainENKUlRN2cl4sycl7handlerEE290000UlvE298_21_B1_branch (
    ...
    input wire [0:0] in_memdep_phi41_pop11,
    input wire [0:0] in_memdep_phi46_pop13,
    ...
    // out_memdep_phi41_pop11(GPOUT,21)
    assign out_memdep_phi41_pop11 = in_memdep_phi41_pop11;

    // out_memdep_phi46_pop13(GPOUT,22)
    assign out_memdep_phi46_pop13 = in_memdep_phi46_pop13;
